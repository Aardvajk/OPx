...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        {
            if(std::system(pcx::str("C:/Projects/Px/Px/build-pc/release/pc -q -I+=../lib foo.pc foo.pi").c_str())) return -1;
            if(std::system(pcx::str("C:/Projects/Px/Px/build-pi/release/pi -q foo.pi foo.po").c_str())) return -1;

            if(std::system(pcx::str("C:/Projects/Px/Px/build-pi/release/pi -q script.pi script.po").c_str())) return -1;
            if(std::system(pcx::str("C:/Projects/Px/Px/build-pl/release/pl -q script.pv script.po foo.po ../lib/stdlib.po").c_str())) return -1;
